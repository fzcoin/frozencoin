...
unlocked to sign the Frozen-Qt.app bundle.
...
allowing somebody to distribute a Frozen-Qt.app or frozen-qt-setup.exe with a valid
...
that the frozen-qt.exe file inside the installer had not been tampered with.
